...
(() => {
  ...
  function dayTopic(w, d) {
    return detailedTopics[w.index - 1]?.[d] || w.knowledge[d % w.knowledge.length] || "本日任务的关键概念";
  }
