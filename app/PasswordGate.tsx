...
export default function PasswordGate() {
  ...
  return <main className="gatePage"><div className="gateOrbits" aria-hidden="true"/><section className="gateCard" aria-labelledby="gate-title">
    ...
    <span className="gateIndex">PRIVATE LEARNING LOG · 50 WEEKS</span><h1 id="gate-title">进入你的<br/><em>学习日志</em></h1>
    ...
    <div className="gateFooter"><span>50 WEEKS</span><i/><span>350 TASKS</span><i/><span>1 LOG</span></div>
  </section></main>;
}
