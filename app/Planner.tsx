...
// The active route redirects to the verified standalone page. Reading references
// are authored once in data/daily-plan.txt and validated against data/guide-sources.json.
// These legacy React fallback tables intentionally contain no invented sections.
